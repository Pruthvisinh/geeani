...
ActiveRecord::Schema.define(version: 2020_06_08_085927) do
  ...
  create_table "degrees", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["college_id"], name: "index_degrees_on_college_id"
  end
  ...
  create_table "semesters", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["degree_id"], name: "index_semesters_on_degree_id"
  end
  ...
  add_foreign_key "degrees", "colleges"
  add_foreign_key "semesters", "degrees"
